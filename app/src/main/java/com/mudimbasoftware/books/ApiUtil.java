...
public class ApiUtil {
    ...
    public static final String QUERY_PARAY_KEY = "q";
    public static final String KEY = "key";
    public static final String API_KEY = "AIzaSyBDCpay2KbKOxrngQy1U2sYd7aEG3SXQwk";

    public  static URL buidURL(String title){
        URL url = null;
        Uri uri = Uri.parse(BASE_API_URL).buildUpon()
                .appendQueryParameter(QUERY_PARAY_KEY,title)
